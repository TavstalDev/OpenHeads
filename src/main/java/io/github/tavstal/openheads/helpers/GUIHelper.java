package io.github.tavstal.openheads.helpers;
...
public class GUIHelper {
    public static final NamespacedKey DupeKey = new NamespacedKey(OpenHeads.Instance, "ProbablyDuped");
    ...
    public static ItemStack createItem(@NotNull Material material, @NotNull String displayName, List<Component> lore, int amount, @Nullable String nbtKey, @Nullable String nbtValue) {
        ...
        if (nbtKey != null && nbtValue != null) {
            NamespacedKey key = new NamespacedKey(OpenHeads.Instance, nbtKey);
